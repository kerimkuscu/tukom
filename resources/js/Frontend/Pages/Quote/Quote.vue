              ...
              <div class="col-md-12 row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <Dropdown id="business" v-model="form.business" class="p-inputtext-sm" :options="businessOptions" optionLabel="text" :placeholder="$t('quote.columns.business')" />
              ...
              <div class="col-md-12 row">
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="company" v-model="form.company" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.company')" :class="{ 'p-invalid': form.errors.has('company')}"/>
                  ...
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="address" v-model="form.address" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.address')" :class="{ 'p-invalid': form.errors.has('address')}"/>
              ...
              <div class="col-md-12 row">
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="zip-code" v-model="form.city_state_zip_country" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.zip_code')" :class="{ 'p-invalid': form.errors.has('city_state_zip_country')}"/>
                  ...
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="phone" v-model="form.phone" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.phone')" :class="{ 'p-invalid': form.errors.has('phone')}"/>
              ...
              <div class="col-md-12 row">
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="fax" v-model="form.fax" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.fax')" :class="{ 'p-invalid': form.errors.has('fax')}"/>
                  ...
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="email" v-model="form.email" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.email')" :class="{ 'p-invalid': form.errors.has('email')}"/>
              ...
              <div class="col-md-12 row">
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="connector-interested" v-model="form.connector_interested_in" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.connect_interested_pn')" :class="{ 'p-invalid': form.errors.has('connector_interested_in')}"/>
                  ...
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="supplier" v-model="form.connector_supplier" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.current_connector_supplier')" :class="{ 'p-invalid': form.errors.has('connector_supplier')}"/>
              ...
              <div class="col-md-12 row">
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="eau" v-model="form.eau" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.eau')" :class="{ 'p-invalid': form.errors.has('eau')}"/>
                  ...
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="project-title" v-model="form.project_title" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.project_title')" :class="{ 'p-invalid': form.errors.has('project_title')}"/>
              ...
              <div class="col-md-12 row">
                  <div class="col-md-6">
                      <div class="form-group row mb-2">
                          ...
                          <div class="col-md-9 grid p-fluid">
                              <InputText id="start-date" v-model="form.project_start_date" class="p-inputtext-sm" type="text" :placeholder="$t('quote.columns.project_start_date')" :class="{ 'p-invalid': form.errors.has('project_start_date')}"/>
