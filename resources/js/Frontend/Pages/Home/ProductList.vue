                            ...
                            <div v-if="option.image !==null"
                                ...
                                >
                                    <template #item="slotProps">
                                        <img :src="originPathName + slotProps.item[1]"
                                    ...
                                    <template #thumbnail="slotProps">
                                        <img :src="originPathName + slotProps.item[1]"
                                             :alt="originPathName + slotProps.item[1]"
                                             style="display: block;cursor: pointer" @click="productDetail(option)">
                                    </template>
                                </Galleria>
                            </div>
                            <div v-else class="p-card-content align-items-center justify-content-center"
                                 style="display: flex; padding: 0">
                                <span>{{ $t('product.frontend.no_image') }}</span>
                            </div>

                            <div class="p-card-footer align-items-center justify-content-center"
